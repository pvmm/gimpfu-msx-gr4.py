...
- For GIMP 3.XX, put the file in a subdirectory with the same name in the plugin directory:
  - if you installed as a normal package, it's `~/.config/GIMP/2.10/plug-ins/gimp_msx_g4`;
  - if you installed as a flatpak package, it's `~/.var/app/org.gimp.GIMP/config/GIMP/2.10/plug-ins/gimp_msx_g4`;
- Restart GIMP
